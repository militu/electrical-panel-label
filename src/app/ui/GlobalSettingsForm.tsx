    ...
    return (
      <div className="space-y-2">
        <div className="flex items-center">
          <Label htmlFor={id} className="w-1/3 text-sm font-medium">
            {label}
          </Label>
        ...
        <div>
          ...
          <div className="space-y-4">
            {renderInputField(
              "BORDER_MARGIN",
              t("borderMargin"),
              formSettings.BORDER_MARGIN,
              handleInputChange,
              t("borderMarginTooltip")
            )}
            {renderInputField(
              "CROSS_SIZE",
              t("crossSize"),
              formSettings.CROSS_SIZE,
              handleInputChange,
              t("crossSizeTooltip")
            )}
          </div>
